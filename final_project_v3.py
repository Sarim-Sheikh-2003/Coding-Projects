        ...
        if user_region in region_list:
            ...
            while True:
                ...
                # Find the country with the greatest population growth from 2000 to 2020 and the country with the least population growth from 2000 to 2020 in the region
                    ...
                    # Printing out the statements for user
                    print(f'The country that had the largest population growth would be {most_growth_country} and its population change by {most_growth}.')
                    print(f'The country that had the lowest population growth would be {least_growth_country} and its population change by {least_growth}.')
